...
class ApiReader(object):
	...
	#    print "wind_chill: "+str(wind_chill)
	    ...
	    spot = InfoSpot(solid_rating=solid_rating,faded_rating=faded_rating,
                    chart_wind_url=chart_wind_url,chart_period_url=chart_period_url,wind_direction=wind_direction,wind_compass_direction=wind_compass_direction,wind_speed=wind_speed,
                    wind_chill=wind_chill, wind_unit=wind_unit,local_timestamp=local_timestamp,id_spot=self.id_spot)
            #It only adds
